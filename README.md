...
To run this application, you need to first clone or download the ‘how to export gantt chart data to excel and csv formats’ repository and then open it in Visual Studio 2019. Now, build and run your project to view the output.
